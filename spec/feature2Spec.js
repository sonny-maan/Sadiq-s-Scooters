describe('another world - weird bug', () => {
  ...
  it('people wait by a ds if no', () => {
    ...
    for (let loopNum = 0; loopNum < 6; loopNum++) {

      worldF2.generatePerson({
    ...
    worldF2.generateDockingStation({
    ...
    expect(worldF2.people.length).toEqual(1)
